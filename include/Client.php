...
class Client
{
     ...
     * @return int    操作结果状态码
     */
    public function sendSMS($mobiles, $content, $sendTime='', $addSerial='', $charset='GBK', $priority=5, $smsId=8888)
    {
        $params = ['arg0'=> $this->serialNumber, 'arg1'=>$this->sessionKey, 'arg2'=>$sendTime,
     ...
     * @return int    操作结果状态码
     */
    public function sendVoice($mobiles, $content, $sendTime='', $addSerial='', $charset='GBK', $priority=5, $smsId=8888)
    {
        $params = ['arg0'=> $this->serialNumber, 'arg1'=>$this->sessionKey, 'arg2'=>$sendTime,
            'arg4'       => $content, 'arg5'=>$addSerial, 'arg6'=>$charset, 'arg7'=>$priority, 'arg8'=>$smsId,
            ];
    ...
    {
        $params = ['arg0'=>$this->serialNumber, 'arg1'=>$this->sessionKey, 'arg2'=>$cardId, 'arg3'=>$cardPass];
